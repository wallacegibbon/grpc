...
-export([encode_msg/2, encode_msg/3, decode_msg/2, decode_msg/3]).

-export([merge_msgs/3, merge_msgs/4, verify_msg/2, verify_msg/3]).

-export([get_msg_defs/0, get_msg_names/0, get_group_names/0,
         get_msg_or_group_names/0, get_enum_names/0]).

-export([find_msg_def/1, fetch_msg_def/1, find_enum_def/1, fetch_enum_def/1]).
...
-export([get_service_names/0, get_service_def/1, get_rpc_names/1]).
...
e_msg_type_parameter(#{type_field := F1}, Bin, TrUserData) ->
    if
        F1 == undefined ->
            Bin;
        true ->
...
e_field_stats_threads([Elem | Rest], Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_stats_threads(id(Elem, TrUserData), Bin2, TrUserData),
    e_field_stats_threads(Rest, Bin3, TrUserData);
e_field_stats_threads([], Bin, _TrUserData) ->
    Bin.

'e_enum_type_parameter.stats_type'(microstate_accounting, Bin) ->
    <<Bin/binary, 0>>;
...
'e_enum_thread.thread_type'(aux, Bin) ->
    <<Bin/binary, 2>>;
'e_enum_thread.thread_type'(V, Bin) ->
    e_varint(V, Bin).

e_type_int32(Value, Bin) when 0 =< Value, Value =< 127 ->
    <<Bin/binary, Value>>;
...
d_msg_counter_stat(Bin, TrUserData) ->
    dfp_read_field_def_counter_stat(Bin, 0, 0, id(0, TrUserData),
...
dfp_read_field_def_counter_stat(<<8, Rest/binary>>, Z1,
    ...
    d_field_counter_stat_aux(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6, TrUserData);
dfp_read_field_def_counter_stat(<<16, Rest/binary>>, Z1,
                                Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    d_field_counter_stat_check_io(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                                  TrUserData);
dfp_read_field_def_counter_stat(<<24, Rest/binary>>, Z1,
                                Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    d_field_counter_stat_emulator(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                                  TrUserData);
dfp_read_field_def_counter_stat(<<32, Rest/binary>>, Z1,
                                Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    d_field_counter_stat_other(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                               TrUserData);
dfp_read_field_def_counter_stat(<<40, Rest/binary>>, Z1,
                                Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    d_field_counter_stat_port(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                              TrUserData);
dfp_read_field_def_counter_stat(<<48, Rest/binary>>, Z1,
                                Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    d_field_counter_stat_sleep(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                               TrUserData);
dfp_read_field_def_counter_stat(<<>>, 0, 0, F1, F2, F3, F4, F5, F6, _) ->
    #{aux => F1, check_io => F2, emulator => F3,
      other => F4, port => F5, sleep => F6};
dfp_read_field_def_counter_stat(Other, Z1, Z2, F1, F2, F3, F4, F5, F6,
                                TrUserData) ->
    dg_read_field_def_counter_stat(Other, Z1, Z2, F1, F2, F3, F4, F5, F6,
                                   TrUserData).

dg_read_field_def_counter_stat(<<1:1, X:7, Rest/binary>>,
                               N, Acc, F1, F2, F3, F4, F5, F6, TrUserData)
        when N < 32 - 7 ->
    dg_read_field_def_counter_stat(Rest, N + 7, X bsl N + Acc, F1, F2, F3, F4,
                                   F5, F6, TrUserData);
dg_read_field_def_counter_stat(<<0:1, X:7, Rest/binary>>,
                               N, Acc, F1, F2, F3, F4, F5, F6, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        8 ->
            d_field_counter_stat_aux(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                     TrUserData);
        16 ->
            d_field_counter_stat_check_io(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                          TrUserData);
        24 ->
            d_field_counter_stat_emulator(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                          TrUserData);
        32 ->
            d_field_counter_stat_other(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                       TrUserData);
        40 ->
            d_field_counter_stat_port(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                      TrUserData);
        48 ->
            d_field_counter_stat_sleep(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                       TrUserData);
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_counter_stat(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                             TrUserData);
                1 ->
                    skip_64_counter_stat(Rest, 0, 0, F1, F2, F3, F4, F5, F6,
                                         TrUserData);
                2 ->
                    skip_length_delimited_counter_stat(Rest, 0, 0, F1, F2, F3,
                                                       F4, F5, F6, TrUserData);
                3 ->
                    skip_group_counter_stat(Rest, Key bsr 3, 0, F1, F2, F3, F4,
                                            F5, F6, TrUserData);
                5 ->
...
dg_read_field_def_counter_stat(<<>>, 0, 0, F1, F2, F3, F4, F5, F6, _) ->
    #{aux => F1, check_io => F2, emulator => F3,
      other => F4, port => F5, sleep => F6}.
...
d_field_counter_stat_aux(<<1:1, X:7, Rest/binary>>, N,
        ...
        when N < 57 ->
    d_field_counter_stat_aux(Rest, N + 7, X bsl N + Acc, F1, F2, F3, F4, F5, F6,
                             TrUserData);
d_field_counter_stat_aux(<<0:1, X:7, Rest/binary>>, N,
                         Acc, _, F2, F3, F4, F5, F6, TrUserData) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    dfp_read_field_def_counter_stat(Rest, 0, 0, NewFValue, F2, F3, F4, F5, F6,
                                    TrUserData).

d_field_counter_stat_check_io(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F1, F2, F3, F4, F5, F6, TrUserData)
        when N < 57 ->
    d_field_counter_stat_check_io(Rest, N + 7, X bsl N + Acc, F1, F2, F3, F4,
                                  F5, F6, TrUserData);
d_field_counter_stat_check_io(<<0:1, X:7, Rest/binary>>,
                              N, Acc, F1, _, F3, F4, F5, F6, TrUserData) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    dfp_read_field_def_counter_stat(Rest, 0, 0, F1, NewFValue, F3, F4, F5, F6,
                                    TrUserData).

d_field_counter_stat_emulator(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F1, F2, F3, F4, F5, F6, TrUserData)
        when N < 57 ->
    d_field_counter_stat_emulator(Rest, N + 7, X bsl N + Acc, F1, F2, F3,
                                  F4, F5, F6, TrUserData);
d_field_counter_stat_emulator(<<0:1, X:7, Rest/binary>>,
                              N, Acc, F1, F2, _, F4, F5, F6, TrUserData) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    dfp_read_field_def_counter_stat(Rest, 0, 0, F1, F2, NewFValue, F4, F5, F6,
                                    TrUserData).

d_field_counter_stat_other(<<1:1, X:7, Rest/binary>>, N,
                           Acc, F1, F2, F3, F4, F5, F6, TrUserData)
        when N < 57 ->
    d_field_counter_stat_other(Rest, N + 7, X bsl N + Acc, F1, F2, F3, F4,
                               F5, F6, TrUserData);
d_field_counter_stat_other(<<0:1, X:7, Rest/binary>>, N,
                           Acc, F1, F2, F3, _, F5, F6, TrUserData) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    dfp_read_field_def_counter_stat(Rest, 0, 0, F1, F2, F3, NewFValue, F5, F6,
                                    TrUserData).

d_field_counter_stat_port(<<1:1, X:7, Rest/binary>>, N,
                          Acc, F1, F2, F3, F4, F5, F6, TrUserData)
        when N < 57 ->
    d_field_counter_stat_port(Rest, N + 7, X bsl N + Acc, F1, F2, F3, F4, F5,
                              F6, TrUserData);
d_field_counter_stat_port(<<0:1, X:7, Rest/binary>>, N,
                          Acc, F1, F2, F3, F4, _, F6, TrUserData) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    dfp_read_field_def_counter_stat(Rest, 0, 0, F1, F2, F3, F4, NewFValue, F6,
                                    TrUserData).

d_field_counter_stat_sleep(<<1:1, X:7, Rest/binary>>, N,
                           Acc, F1, F2, F3, F4, F5, F6, TrUserData)
        when N < 57 ->
    d_field_counter_stat_sleep(Rest, N + 7, X bsl N + Acc, F1, F2, F3, F4, F5,
                               F6, TrUserData);
d_field_counter_stat_sleep(<<0:1, X:7, Rest/binary>>, N,
                           Acc, F1, F2, F3, F4, F5, _, TrUserData) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    dfp_read_field_def_counter_stat(Rest, 0, 0, F1, F2, F3, F4, F5, NewFValue,
                                    TrUserData).

skip_varint_counter_stat(<<1:1, _:7, Rest/binary>>, Z1,
                         Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    skip_varint_counter_stat(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                             TrUserData);
skip_varint_counter_stat(<<0:1, _:7, Rest/binary>>, Z1,
                         Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    dfp_read_field_def_counter_stat(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                                    TrUserData).

skip_length_delimited_counter_stat(<<1:1, X:7, Rest/binary>>,
                                   N, Acc, F1, F2, F3, F4, F5, F6, TrUserData)
        when N < 57 ->
    skip_length_delimited_counter_stat(Rest, N + 7, X bsl N + Acc, F1, F2, F3,
                                       F4, F5, F6, TrUserData);
skip_length_delimited_counter_stat(<<0:1, X:7, Rest/binary>>,
                                   N, Acc, F1, F2, F3, F4, F5, F6,
                                   TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_counter_stat(Rest2, 0, 0, F1, F2, F3, F4, F5, F6,
                                    TrUserData).

skip_group_counter_stat(Bin, FNum, Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_counter_stat(Rest, 0, Z2, F1, F2, F3, F4, F5, F6,
                                    TrUserData).
...
skip_64_counter_stat(<<_:64, Rest/binary>>, Z1, Z2, F1, F2, F3, F4, F5, F6,
                     TrUserData) ->
    dfp_read_field_def_counter_stat(Rest, Z1, Z2, F1, F2, F3, F4, F5, F6,
                                    TrUserData).
...
dfp_read_field_def_type_parameter(<<8, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
    d_field_type_parameter_type_field(Rest, Z1, Z2, F1, TrUserData);
dfp_read_field_def_type_parameter(<<>>, 0, 0, F1, _) ->
    #{type_field => F1};
dfp_read_field_def_type_parameter(Other, Z1, Z2, F1, TrUserData) ->
    dg_read_field_def_type_parameter(Other, Z1, Z2, F1, TrUserData).

dg_read_field_def_type_parameter(<<1:1, X:7, Rest/binary>>,
                                 N, Acc, F1, TrUserData)
        when N < 32 - 7 ->
    dg_read_field_def_type_parameter(Rest, N + 7, X bsl N + Acc, F1,
                                     TrUserData);
dg_read_field_def_type_parameter(<<0:1, X:7, Rest/binary>>,
                                 N, Acc, F1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        8 ->
            d_field_type_parameter_type_field(Rest, 0, 0, F1, TrUserData);
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_type_parameter(Rest, 0, 0, F1, TrUserData);
                1 ->
                    skip_64_type_parameter(Rest, 0, 0, F1, TrUserData);
                2 ->
                ...
                3 ->
                    skip_group_type_parameter(Rest, Key bsr 3, 0, F1,
                                              TrUserData);
                5 ->
                    skip_32_type_parameter(Rest, 0, 0, F1, TrUserData)
            end
    end;
dg_read_field_def_type_parameter(<<>>, 0, 0, F1, _) ->
    #{type_field => F1}.

d_field_type_parameter_type_field(<<1:1, X:7, Rest/binary>>,
                                  N, Acc, F1, TrUserData)
        when N < 57 ->
    d_field_type_parameter_type_field(Rest, N + 7, X bsl N + Acc, F1,
                                      TrUserData);
d_field_type_parameter_type_field(<<0:1, X:7, Rest/binary>>,
                                  N, Acc, _, TrUserData) ->
    <<Tmp:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    NewFValue = 'd_enum_type_parameter.stats_type'(Tmp),
    dfp_read_field_def_type_parameter(Rest, 0, 0, NewFValue, TrUserData).

skip_varint_type_parameter(<<1:1, _:7, Rest/binary>>,
                           Z1, Z2, F1, TrUserData) ->
    skip_varint_type_parameter(Rest, Z1, Z2, F1, TrUserData);
skip_varint_type_parameter(<<0:1, _:7, Rest/binary>>,
                           Z1, Z2, F1, TrUserData) ->
    dfp_read_field_def_type_parameter(Rest, Z1, Z2, F1, TrUserData).

skip_length_delimited_type_parameter(<<1:1, X:7, Rest/binary>>,
                                     N, Acc, F1, TrUserData)
        when N < 57 ->
    skip_length_delimited_type_parameter(Rest, N + 7, X bsl N + Acc, F1,
                                         TrUserData);
skip_length_delimited_type_parameter(<<0:1, X:7, Rest/binary>>,
                                     N, Acc, F1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_type_parameter(Rest2, 0, 0, F1, TrUserData).

skip_group_type_parameter(Bin, FNum, Z2, F1, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_type_parameter(Rest, 0, Z2, F1, TrUserData).

skip_32_type_parameter(<<_:32, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
    dfp_read_field_def_type_parameter(Rest, Z1, Z2, F1, TrUserData).

skip_64_type_parameter(<<_:64, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
    dfp_read_field_def_type_parameter(Rest, Z1, Z2, F1, TrUserData).

d_msg_thread(Bin, TrUserData) ->
    dfp_read_field_def_thread(Bin, 0, 0, id(undefined, TrUserData),
                              id(0, TrUserData), id(async, TrUserData),
                              TrUserData).

dfp_read_field_def_thread(<<10, Rest/binary>>, Z1, Z2, F1, F2, F3,
                          TrUserData) ->
    d_field_thread_counters(Rest, Z1, Z2, F1, F2, F3, TrUserData);
...
dfp_read_field_def_thread(<<24, Rest/binary>>, Z1, Z2,
                          F1, F2, F3, TrUserData) ->
    d_field_thread_type(Rest, Z1, Z2, F1, F2, F3, TrUserData);
dfp_read_field_def_thread(<<>>, 0, 0, F1, F2, F3, _) ->
    #{counters => F1, id => F2, type => F3};
dfp_read_field_def_thread(Other, Z1, Z2, F1, F2, F3, TrUserData) ->
    dg_read_field_def_thread(Other, Z1, Z2, F1, F2, F3, TrUserData).

dg_read_field_def_thread(<<1:1, X:7, Rest/binary>>, N,
                         Acc, F1, F2, F3, TrUserData)
        when N < 32 - 7 ->
    dg_read_field_def_thread(Rest, N + 7, X bsl N + Acc, F1, F2, F3,
                             TrUserData);
dg_read_field_def_thread(<<0:1, X:7, Rest/binary>>, N,
    ...
    case Key of
        10 ->
            d_field_thread_counters(Rest, 0, 0, F1, F2, F3, TrUserData);
        16 ->
        ...
        _ ->
            case Key band 7 of
                ...
                1 ->
                    skip_64_thread(Rest, 0, 0, F1, F2, F3, TrUserData);
                2 ->
                ...
                3 ->
                    skip_group_thread(Rest, Key bsr 3, 0, F1, F2, F3,
                                      TrUserData);
                5 ->
                    skip_32_thread(Rest, 0, 0, F1, F2, F3, TrUserData)
            end
    end;
dg_read_field_def_thread(<<>>, 0, 0, F1, F2, F3, _) ->
    #{counters => F1, id => F2, type => F3}.

d_field_thread_counters(<<1:1, X:7, Rest/binary>>, N, Acc, F1, F2, F3,
                        TrUserData)
        when N < 57 ->
    d_field_thread_counters(Rest, N + 7, X bsl N + Acc, F1, F2, F3,
                            TrUserData);
...
d_field_thread_id(<<1:1, X:7, Rest/binary>>, N, Acc, F1, F2, F3, TrUserData)
        when N < 57 ->
    d_field_thread_id(Rest, N + 7, X bsl N + Acc, F1, F2, F3, TrUserData);
d_field_thread_id(<<0:1, X:7, Rest/binary>>, N, Acc, F1, _, F3, TrUserData) ->
    <<NewFValue:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    dfp_read_field_def_thread(Rest, 0, 0, F1, NewFValue, F3, TrUserData).

d_field_thread_type(<<1:1, X:7, Rest/binary>>, N, Acc, F1, F2, F3, TrUserData)
        when N < 57 ->
    d_field_thread_type(Rest, N + 7, X bsl N + Acc, F1, F2, F3, TrUserData);
d_field_thread_type(<<0:1, X:7, Rest/binary>>, N, Acc, F1, F2, _, TrUserData) ->
    <<Tmp:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
    NewFValue = 'd_enum_thread.thread_type'(Tmp),
    dfp_read_field_def_thread(Rest, 0, 0, F1, F2, NewFValue, TrUserData).

skip_varint_thread(<<1:1, _:7, Rest/binary>>, Z1, Z2, F1, F2, F3, TrUserData) ->
    skip_varint_thread(Rest, Z1, Z2, F1, F2, F3, TrUserData);
skip_varint_thread(<<0:1, _:7, Rest/binary>>, Z1, Z2, F1, F2, F3, TrUserData) ->
    dfp_read_field_def_thread(Rest, Z1, Z2, F1, F2, F3, TrUserData).

skip_length_delimited_thread(<<1:1, X:7, Rest/binary>>,
                             N, Acc, F1, F2, F3, TrUserData)
        when N < 57 ->
    skip_length_delimited_thread(Rest, N + 7, X bsl N + Acc, F1, F2, F3,
                                 TrUserData);
skip_length_delimited_thread(<<0:1, X:7, Rest/binary>>,
                             N, Acc, F1, F2, F3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_thread(Rest2, 0, 0, F1, F2, F3, TrUserData).

skip_group_thread(Bin, FNum, Z2, F1, F2, F3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_thread(Rest, 0, Z2, F1, F2, F3, TrUserData).

skip_32_thread(<<_:32, Rest/binary>>, Z1, Z2, F1, F2, F3, TrUserData) ->
    dfp_read_field_def_thread(Rest, Z1, Z2, F1, F2, F3, TrUserData).

skip_64_thread(<<_:64, Rest/binary>>, Z1, Z2, F1, F2, F3, TrUserData) ->
    dfp_read_field_def_thread(Rest, Z1, Z2, F1, F2, F3, TrUserData).

d_msg_stats(Bin, TrUserData) ->
    dfp_read_field_def_stats(Bin, 0, 0, id([], TrUserData), TrUserData).

dfp_read_field_def_stats(<<10, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
...
dfp_read_field_def_stats(Other, Z1, Z2, F1, TrUserData) ->
    dg_read_field_def_stats(Other, Z1, Z2, F1, TrUserData).

dg_read_field_def_stats(<<1:1, X:7, Rest/binary>>, N, Acc, F1, TrUserData)
        when N < 32 - 7 ->
    dg_read_field_def_stats(Rest, N + 7, X bsl N + Acc, F1, TrUserData);
dg_read_field_def_stats(<<0:1, X:7, Rest/binary>>, N, Acc, F1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 ->
            d_field_stats_threads(Rest, 0, 0, F1, TrUserData);
        _ ->
            case Key band 7 of
...
d_field_stats_threads(<<1:1, X:7, Rest/binary>>, N, Acc, F1, TrUserData)
        when N < 57 ->
    d_field_stats_threads(Rest, N + 7, X bsl N + Acc, F1, TrUserData);
d_field_stats_threads(<<0:1, X:7, Rest/binary>>, N, Acc,
                      F1, TrUserData) ->
    Len = X bsl N + Acc,
    <<Bs:Len/binary, Rest2/binary>> = Rest,
    NewFValue = id(d_msg_thread(Bs, TrUserData), TrUserData),
    dfp_read_field_def_stats(Rest2, 0, 0, cons(NewFValue, F1, TrUserData),
                             TrUserData).

skip_varint_stats(<<1:1, _:7, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
    skip_varint_stats(Rest, Z1, Z2, F1, TrUserData);
skip_varint_stats(<<0:1, _:7, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
    dfp_read_field_def_stats(Rest, Z1, Z2, F1, TrUserData).

skip_length_delimited_stats(<<1:1, X:7, Rest/binary>>, N, Acc, F1, TrUserData)
        when N < 57 ->
    skip_length_delimited_stats(Rest, N + 7, X bsl N + Acc, F1, TrUserData);
...
skip_32_stats(<<_:32, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
    dfp_read_field_def_stats(Rest, Z1, Z2, F1, TrUserData).

skip_64_stats(<<_:64, Rest/binary>>, Z1, Z2, F1, TrUserData) ->
    dfp_read_field_def_stats(Rest, Z1, Z2, F1, TrUserData).
